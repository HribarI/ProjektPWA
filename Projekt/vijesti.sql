...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1799759965ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vijesti&table=baza">`vijesti`.`baza`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vijesti&table=korisnik">`vijesti`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tblsubcategory">`newsportal`.`tblsubcategory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tblposts">`newsportal`.`tblposts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tblpages">`newsportal`.`tblpages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tblcomments">`newsportal`.`tblcomments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tblcategory">`newsportal`.`tblcategory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsportal&table=tbladmin">`newsportal`.`tbladmin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=projekt&table=timovi">`projekt`.`timovi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=muzika&table=pjesma">`muzika`.`pjesma`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="564a434339384424254d495579472363">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="vijesti" targettable="baza">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `baza`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vijesti" targettable="baza">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            targetdb="vijesti" targettable="korisnik">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `vijesti`.`korisnik` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `ime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `prezime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `korisnicko_ime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `lozinka` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `razina` TINYINT(1) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="vijesti" targettable="korisnik">
                            <div class="action_content">
